	    ...
	    public static void main(String[] args) {
	        ...
	        // 1. Crear un array de 5 enteros e imprimirlos uno a uno.
	    		...
	    		for (int i = 0; i < arr.length;i++) {
	    			System.out.println("el array contiene los siguientes numero: " + arr[i]);
	    		}
	    	
	    	

	        // 2. Crear un array de 3 Strings con nombres e imprimirlos.ç
	    		
	    		String[] MisHermanos = {"Mina","Frankie","Borja"};
	    		
	    		for (int i = 0; i <MisHermanos.length; i++) {
	    			System.out.println("Los nombres de mi hermanos son: " + MisHermanos[i]);
	    		}
